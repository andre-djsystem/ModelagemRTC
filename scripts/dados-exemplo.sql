...
DELETE FROM TIPO_PARTICIPANTE;
INSERT INTO TIPO_PARTICIPANTE (ID_PARTICIPANTE, DESCRICAO) VALUES  (0, 'Não Definido');
INSERT INTO TIPO_PARTICIPANTE (ID_PARTICIPANTE, DESCRICAO) VALUES  (1, 'Pessoa Física');
INSERT INTO TIPO_PARTICIPANTE (ID_PARTICIPANTE, DESCRICAO) VALUES  (2, 'Pessoa Jurídica');
INSERT INTO TIPO_PARTICIPANTE (ID_PARTICIPANTE, DESCRICAO) VALUES  (3, 'Orgão Público/CEBAS');
INSERT INTO TIPO_PARTICIPANTE (ID_PARTICIPANTE, DESCRICAO) VALUES  (4, 'Produtor Rural Não Contribuinte');
...
INSERT INTO TOP (ID_TOP, DESCRICAO, CCLASSTRIB) VALUES (3, 'Transferência entre Filiais', '410002');
INSERT INTO TOP (ID_TOP, DESCRICAO, CCLASSTRIB) VALUES (4, 'Devolução de Venda', NULL);
INSERT INTO TOP (ID_TOP, DESCRICAO, CCLASSTRIB) VALUES (5, 'Doações sem contraprestação em benefício do doador', '410003');
